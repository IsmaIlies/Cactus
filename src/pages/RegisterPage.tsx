...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const firebaseAuthCode = error.details?.rawCode;
      // Ici on mappe les erreurs backend dans le state errors
      const newErrors: { [key: string]: string } = {};

      if (firebaseAuthCode === "auth/email-already-exists") {
        newErrors.email = "L'email est déjà utilisé.";
      } else if (firebaseAuthCode === "auth/invalid-email") {
        newErrors.email = "L'email est invalide.";
      } else if (firebaseAuthCode === "auth/weak-password") {
        newErrors.password = "Le mot de passe est trop faible.";
      } else {
        newErrors.form = "Une erreur est survenue. Veuillez réessayer.";
      }
